...
class ProfileVisitFollowersAdapter(val followersList : List<Follower>, val context : Context) :
    RecyclerView.Adapter<ProfileVisitFollowersAdapter.MainViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ProfileVisitFollowersAdapter.MainViewHolder {
